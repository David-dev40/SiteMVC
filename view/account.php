...
<main id="account">
    ...
    <section class="form">
        ...
        <form action="index.php?action=account" method="POST" novalidate>
            ...
            <p><label for="prenom">Prénom : </label><br /><input type="text" name="prenom" id="prenom" value='' /></p>
    ...
    <section class="form">
        ...
        <form action="index.php?action=account" method="POST" novalidate>
            ...
            <p><label for="reponse">Ma nouvelle réponse : </label><br /><input type="text" name="reponse" id="reponse" value=''/></p>
