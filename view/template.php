...
<body>
    <header>
        ...
        <header id="header_form">
            <div><a href="index.php?action=pageHome"><img id="logoGBAF" src ="public/img/logo_gbaf.png" alt="logo de GBAF" /></div>
        ...
        <?php ob_start(); ?>
        <header id="header">
            <div><a href="index.php?action=pageHome"><img id="logo" src="public/img/logo_gbaf.png" alt="logo de GBAF" /></div>
            <div id="user">
